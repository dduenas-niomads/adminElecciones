...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Validar perfil de votante - {{ $voter->code }}</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('voter-validate-info') }}">
                        @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="email" maxlength="100" type="text" class="form-control" name="email" value="{{ $voter->email }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="phone" class="col-md-4 col-form-label text-md-right">TELÉFONO: </label>
                                <div class="col-md-8">
                                    <input id="phone" maxlength="25" type="text" class="form-control" name="phone" value="{{ $voter->phone }}" required>
                                </div>
                            </div>
